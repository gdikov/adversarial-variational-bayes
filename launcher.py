...
if __name__ == '__main__':
    ...
    train_data, train_labels = data['data'][:10], data['target'][:10]
    ...
    model_dir = trainer.run_training(train_data, batch_size=10, epochs=20)
    trained_model = trainer.get_model()

    latent_vars = trained_model.infer(train_data, batch_size=10)
    ...
    plot_sampled_data(generations, sample_side_size=2, fig_dirpath='output/')
